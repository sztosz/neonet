...
class CommodityInQuickList(models.Model):
    ...
    serial = models.CharField(max_length=50, verbose_name='Numer seryjny', blank=True)
    comment = models.CharField(max_length=100, verbose_name='Opis towaru', blank=True)
