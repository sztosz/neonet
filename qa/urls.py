...
urlpatterns = patterns('',
                       ...
                       url(r'^damage_reports/export/$', views.DamageReportsExportView.as_view(),
                           name='damage_report_export'),
                       url(r'^damage_reports/create/$', views.DamageReportsCreateView.as_view(),
                           name='damage_report_create'),
                       url(r'^damage_reports/update/(?P<pk>\d+)$', views.DamageReportsUpdateView.as_view(),
