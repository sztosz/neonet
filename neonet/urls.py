...
urlpatterns = patterns(
    ...
    url(r'^returns/', include('CommercialReturns.urls', namespace='CommercialReturns')),
    url(r'^commodities/', include('Commodities.urls', namespace='Commodities')),
    url(r'^reports/', include('DamageReports.urls', namespace='DamageReports')),
    url(r'^lists/', include('QuickCommodityLists.urls', namespace='QuickCommodityLists')),

    url(r'^login/$', 'django.contrib.auth.views.login', {'template_name': 'neonet/login.html'},
        name='login'),
